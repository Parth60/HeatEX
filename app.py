...
tab_run, tab_geometry, tab_bell, tab_optimizer, tab_export = st.tabs(
    ["🏁 LIVE RUN", "🧩 GEOMETRY", "📡 BELL–DELAWARE", "🏎️ OPTIMISER", "📄 TECH PACK"]
)
...
st.caption(
    "HX//RACE v0.4 · Shell-and-tube optimisation build · "
