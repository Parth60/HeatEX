...
st.markdown(
    ...
    <div class="hx-topline">
        ...
        <span>•</span>
        <span>v0.8 MULTICOMPONENT HX PRO</span>
    </div>
...
tab_run, tab_thermo, tab_flash, tab_multi, tab_phase, tab_geometry, tab_bell, tab_optimizer, tab_export = st.tabs(
    [
        "🏁 LIVE RUN",
        "🧪 THERMODYNAMICS",
        "⚗️ FLASH / VLE",
...
if sim_error:
    ...
    with tab_export:
        st.markdown("### Technical Pack — v0.8")
...
st.caption(
    "HX//RACE v0.8 · Multicomponent Phase-Change Integration · "
