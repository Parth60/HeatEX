...
tab_run, tab_thermo, tab_flash, tab_phase, tab_geometry, tab_bell, tab_optimizer, tab_export = st.tabs(
    [
        "🏁 LIVE RUN",
        "🧪 THERMODYNAMICS",
        "⚗️ FLASH / VLE",
...
if sim_error:
    ...
    with tab_export:
        st.markdown("### Technical Pack — v0.7")
